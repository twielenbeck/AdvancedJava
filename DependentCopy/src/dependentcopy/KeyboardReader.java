...
/**
 * A simple class that demonstrates a capability to read a line of 
 * text entered from the keyboard. Notice this class has no abstract
 * interface; it is derived from the base class <code>Object</code> and extends 
 * the base interface with its own (non-abstract) method, readln().
 * 
